    ...
    <form method="GET" action="/jucator">
        ...
        <div class="d-flex div_filter">
            ...
            <div class="input-group mb-3 col-3">
                ...
                <input title="A se tasta '-' pentru jucatorii fara echipa" type="text" name="echipa" id="cauta_echipa" class="form-control" placeholder="Cauta echipa" value="{{old('echipa')}}" />
            </div>
            <div class="input-group mb-3 col-3">
                <div class="input-group-prepend">
