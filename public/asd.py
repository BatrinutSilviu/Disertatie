...
def train():
    ...
    for i in range(iterations):
        ...
        if point[2] == "fundas":
            ...
            if math.isnan(point[35]):
                point[35] = 0
            z = float(point[23]) * w1Fundas + float(point[11]) * w2Fundas + float(point[18]) * w3Fundas + float(point[19]) * w4Fundas + float(point[20]) * w5Fundas + float(point[22]) * w6Fundas + float(point[26]) * w7Fundas + float(point[28]) * w8Fundas + float(point[29]) * w9Fundas + float(point[30]) * w10Fundas + float(point[31]) * w11Fundas + float(point[34]) * w12Fundas + float(point[35]) * w13Fundas + float(point[16]) * w14Fundas + bFundas
        if point[2] == "mijlocas":
            if math.isnan(point[34]):
                point[34] = 0
            if math.isnan(point[35]):
                point[35] = 0
            z = float(point[35]) * w1Mijlocas + float(point[9]) * w2Mijlocas + float(point[10]) * w3Mijlocas + float(point[11]) * w4Mijlocas + float(point[13]) * w5Mijlocas + float(point[14]) * w6Mijlocas + float(point[16]) * w7Mijlocas + float(point[17]) * w8Mijlocas + float(point[18]) * w9Mijlocas + float(point[19]) * w10Mijlocas + float(point[22]) * w11Mijlocas + float(point[23]) * w12Mijlocas + float(point[24]) * w13Mijlocas + float(point[26]) * w14Mijlocas + float(point[28]) * w15Mijlocas + float(point[29]) * w16Mijlocas + float(point[30]) * w17Mijlocas + float(point[31]) * w18Mijlocas + float(point[33]) * w19Mijlocas + float(point[34]) * w20Mijlocas + bMijlocas
        if point[2] == "atacant":
            if math.isnan(point[34]):
                point[34] = 0
            if math.isnan(point[35]):
                point[35] = 0
            z = float(point[9]) * w1Atacant + float(point[10]) * w2Atacant + float(point[11]) * w3Atacant + float(point[13]) * w4Atacant + float(point[14]) * w5Atacant + float(point[16]) * w6Atacant + float(point[17]) * w7Atacant + float(point[18]) * w8Atacant + float(point[19]) * w9Atacant + float(point[20]) * w10Atacant + float(point[23]) * w11Atacant + float(point[24]) * w12Atacant + float(point[26]) * w13Atacant + float(point[28]) * w14Atacant + float(point[33]) * w15Atacant + float(point[34]) * w16Atacant + float(point[35]) * w17Atacant + bAtacant
    ...
    w12Fundas, w13Fundas, w14Fundas, w1Mijlocas, w2Mijlocas, w3Mijlocas, w4Mijlocas, w5Mijlocas, w6Mijlocas, w7Mijlocas, w8Mijlocas, w9Mijlocas, w10Mijlocas,\
    w11Mijlocas, w12Mijlocas, w13Mijlocas, w14Mijlocas, w15Mijlocas, w16Mijlocas, w17Mijlocas, w18Mijlocas, w19Mijlocas, w20Mijlocas,\
    ...
    bPortar, bFundas, bMijlocas, bAtacant
...
w14Fundas, w1Mijlocas, w2Mijlocas, w3Mijlocas, w4Mijlocas, w5Mijlocas, w6Mijlocas, w7Mijlocas, w8Mijlocas, w9Mijlocas, w10Mijlocas, w11Mijlocas, w12Mijlocas,\
w13Mijlocas, w14Mijlocas, w15Mijlocas, w16Mijlocas, w17Mijlocas, w18Mijlocas, w19Mijlocas, w20Mijlocas, w1Atacant, w2Atacant, w3Atacant,\
w4Atacant, w5Atacant, w6Atacant, w7Atacant, w8Atacant, w9Atacant, w10Atacant, w11Atacant, w12Atacant, w13Atacant, w14Atacant, w15Atacant, w16Atacant, w17Atacant,\
...
+" "+ repr(w6Fundas)+" "+ repr(w7Fundas)+" "+ repr(w8Fundas)+" "+ repr(w9Fundas)+" "+ repr(w10Fundas)+" "+ repr(w11Fundas)+" "+ repr(w12Fundas)+" "+ repr(w13Fundas)+" "+ repr(w14Fundas)\
...
+" "+ repr(w14Mijlocas)+" "+ repr(w15Mijlocas)+" "+ repr(w16Mijlocas)+" "+ repr(w17Mijlocas)+" "+ repr(w18Mijlocas)+" "+ repr(w19Mijlocas)+" "+ repr(w20Mijlocas)+" "+ repr(w1Atacant)\
...
+" "+ repr(w16Atacant)+" "+ repr(w17Atacant)+" "+ repr(bPortar)+" "+ repr(bFundas)+" "+ repr(bMijlocas)+" "+ repr(bAtacant))
f.close()
